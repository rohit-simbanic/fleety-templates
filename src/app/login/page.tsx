        ...
        <Card className="p-8 border-foreground/5 bg-background/50 relative">
          ...
          {success ? (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-foreground">Sign In Secure</h3>
              <p className="text-xs text-foreground/60 leading-relaxed max-w-xs mx-auto">
                Authentication verified. Syncing dispatch telematics centers...
              </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="text-center mb-2">
                <h2 className="text-xl md:text-2xl font-black text-foreground">Welcome Back</h2>
                <span className="text-xs text-foreground/50 block mt-1">Access your operations command center</span>
              </div>
              ...
              {/* Password */}
              <div className="flex flex-col gap-1.5">
                <div className="flex justify-between items-center text-[10px] uppercase font-bold text-foreground/50">
                  <label>Password</label>
                  <a href="#" className="text-primary hover:underline lowercase tracking-normal">Forgot?</a>
                </div>
                <div className="relative">
              ...
              {/* OAuth split */}
              <div className="flex items-center gap-3 my-2 text-foreground/30 text-[10px] uppercase font-bold">
              ...
              <div className="text-center text-xs text-foreground/50 mt-2 font-medium">
                <span>New to Fleety? </span>
                <Link href="/register" className="text-primary hover:underline font-bold">Create Free Account</Link>
              </div>
